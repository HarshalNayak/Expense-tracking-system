...
def main():
    ...
    expense_file_path ="Expense tracking App\\expense.csv"
    budget = 2000
...
def get_user_expense():
    ...
    expense_categories = ["Food","Room rent","traveling","fun","misc",]
    ...
    while True:
        ...
        selected_index =int(input("Enter a category number {value range}: ")) -1
